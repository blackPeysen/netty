...
/**
 * 一个特殊的{@link ChannelInboundHandler}，它提供了一种简单的方法来初始化一个{@link Channel}注册到其{@link EventLoop}。
 *
 * 实现通常在{@link Bootstrap#handler(ChannelHandler)}的上下文中使用，
 ...
 * ...
 * </pre>
 * 请注意，这个类被标记为{@link Sharable}，因此必须安全地重用它的实现。
 *
